  ...
  <div class="container">
      ...
      <nav class="navbar">
        ...
        <div class="navbar-wrapper">
          ...
          <ul class="navbar-nav">
            ...
            <li>
              <a href="logout.php" class="nav-link" style="border:2px solid var(--saffron);padding: 10px;border-radius: 40px;">Log Out</a>
            </li>
    ...
    <main>
      ...
      <section class="home" id="home">
        ...
        <div class="home-left">
          ...
          <p class="home-subtext">Hi, <?php echo $user_data['user_name'] ?></p>
    ...
    <footer>
      ...
      <div class="footer-wrapper">
        ...
        <a href="#">
          <img src="./assets/images/logo.png" alt="logo" class="footer-brand" width="130">
        </a>
        ...
        <p class="copyright">&copy; Copyright 2024 GitikaVerma. All Rights Reserved.</p>
